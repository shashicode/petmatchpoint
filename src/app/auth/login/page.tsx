    ...
    <section className="h-screen">
      <div className="container h-full px-6 py-24">
        <div className="g-6 flex h-full flex-wrap items-center justify-center">
          <div className="w-[500px] p-12 w-[500px] text-center bg-gray-600">
            {/* Login Page */}
            ...
            <form>
              ...
              {wrongEmailPass && 
                <div className="text-red-500 font-bold text-xl mb-3">Wrong email and password combination</div>
              }
              <div
              ...
              >
                {showSpinner ? <><div className="flex justify-center" role="status">
